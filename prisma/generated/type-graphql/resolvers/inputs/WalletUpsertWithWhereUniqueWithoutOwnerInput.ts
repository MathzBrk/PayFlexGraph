...
@TypeGraphQL.InputType("WalletUpsertWithWhereUniqueWithoutOwnerInput", {})
export class WalletUpsertWithWhereUniqueWithoutOwnerInput {
  ...
  update!: WalletUpdateWithoutOwnerInput;
